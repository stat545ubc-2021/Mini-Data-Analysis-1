...
<!-------------------------- Start your work below ---------------------------->
```{R}
aov.data <- aov(achievements ~ review, data=games_achievement_fct)
...
augment(aov.data, newdata = new_data)
glance(aov.data)
```
...
achievement_summary <- games_achievement_fct %>%
  ...
  summarize(mean_achievements = mean(achievements), 
            ...
            n = n())
write.csv(achievement_summary, here::here('output', 'game_achievmenet_summary.csv'))
read.csv(here::here('output','game_achievmenet_summary.csv'))
```
